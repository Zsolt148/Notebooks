<x-app-layout>
        ...
        <div class="my-10 mx-auto max-w-2xl justify-center" x-data="{ open: true }" x-show="open">
            <div class="flex sm:flex-row sm:items-center bg-white dark:bg-gray-600 shadow rounded-md py-5 pl-6 pr-8 sm:pr-6">
                <div class="flex flex-row items-center border-b sm:border-b-0 w-1/2 sm:w-auto pb-4 sm:pb-0">
                    ...
                    <div class="text-xl font-medium ml-3">Sikeresen elküldte üzenetét!</div>
                </div>
                <div class="text-sm tracking-wide text-gray-600 dark:text-gray-200 mt-4 sm:mt-0 sm:ml-4">Köszönjük!</div>
    ...
    <section class="w-full max-w-2xl px-6 py-4 mx-auto bg-white rounded-md shadow-xl mt-10">
        ...
        <h2 class="text-3xl font-semibold text-center text-gray-800 dark:text-white">Lépj velünk kapcsolatba!</h2>
        <p class="mt-3 text-center text-gray-600 dark:text-gray-400">Ha van bármi kérdésed, nyugodtan dobj egy
            üzenetet.</p>
            ...
            <div class="mt-6">
                <div class="items-center -mx-2 md:flex">
                    <div class="w-full mx-2">
                        <label class="block mb-2 text-sm font-medium text-gray-600">Név</label>
                    ...
                    <div class="w-full mx-2 mt-4 md:mt-0">
                        <label class="block mb-2 text-sm font-medium text-gray-600">E-mail cím</label>
                ...
                <div class="w-full mt-4">
                    <label for="email" class="block text-sm leading-7 text-gray-600">Lakhely</label>
                    <select name="location"
                            ...
                            required>
                        <option selected value="hun">Magyarország</option>
                        <option value="other">Külföld</option>
                    </select>
                </div>

                <div class="w-full mt-4">
                    <label class="block mb-2 text-sm font-medium text-gray-600">Üzenet</label>
                    <textarea name="text"
                              id="text"
